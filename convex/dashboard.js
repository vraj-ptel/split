...
export const getUserBalances = query({
  handler: async (ctx) => {
    ...
    // find settlements if any settle ment exist then change user owe or user owed according to it k
    ...
    // const s= (await ctx.db.query('settlements').collect()).filter((s)=>s.paidByUserId==user._id || s.receivedByUserId==user._id);
