    ...
    <div>
      <header className="fixed top-0 left-0 w-full border-b backdrop-blur-md bg-white/80 dark:bg-black/80 z-50">
        <div className="container mx-auto px-3 sm:px-4 py-3 sm:py-4 flex justify-between items-center">
          ...
          {path == "/" && (
            <div className="md:gap-4 flex flex-row">
              <Link
                href="#features"
                className="text-sm scroll-smooth font-medium hover:text-green-600 transition-all"
              >
                Features
              </Link>
              <Link
              ...
              <div className="flex gap-1 sm:gap-2">
                <SignInButton mode="modal">
                  <Button
                    size="sm"
                    variant={"outline"}
                    className="text-xs cursor-pointer sm:text-sm px-2 sm:px-4"
                  >
                    <User2 />
                    Sign In
                  </Button>
